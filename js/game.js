...
class MainScene extends Phaser.Scene {
	...
	create() {
		...
		this.textures.generate('playerA', {data: playerAPixles, pixelWidth: pixelWidth});
		this.textures.generate('enemy1', {data: enemyAPixles, pixelWidth: pixelWidth});

		this.textures.generate('coin', {data: coinPixles, pixelWidth: pixelWidth});
		this.textures.generate('powerUp1', {data: powerUp1Pixles, pixelWidth: pixelWidth});
		this.textures.generate('bullet1', {data: bullet1Pixles, pixelWidth: pixelWidth});
		...
		this.platforms.create(800, 600 - 10, 'ground1').setScale(100, 1).refreshBody();
	...
	tryFireBullet(actor) {
		if (this.input.activePointer.isDown || this.inputs.aio.attack.isDown) {
